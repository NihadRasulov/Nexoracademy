...
export const chatSessionConfig: ResourceConfig<ChatSessionRow> = {
  ...
  apiPath: "/api/sales/chat-sessions",
  idField: "id",
  roleGroup: "salesCrm",
  searchKeys: ["channel"],
  columns: [
...
export const contactSubmissionConfig: ResourceConfig<ContactSubmissionRow> = {
  ...
  apiPath: "/api/sales/contact-submissions",
  idField: "id",
  roleGroup: "salesCrm",
