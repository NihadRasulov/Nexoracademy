...
export const campaignConfig: ResourceConfig<CampaignRow> = {
  ...
  apiPath: "/api/v1/sales/campaigns",
  idField: "id",
  roleGroup: "salesCrm",
  searchKeys: ["name"],
  columns: [
...
export const chatSessionConfig: ResourceConfig<ChatSessionRow> = {
  ...
  apiPath: "/api/v1/sales/chat-sessions",
  idField: "id",
  roleGroup: "salesCrm",
  searchKeys: ["channel"],
  columns: [
...
export const contactSubmissionConfig: ResourceConfig<ContactSubmissionRow> = {
  ...
  apiPath: "/api/v1/sales/contact-submissions",
  idField: "id",
  roleGroup: "salesCrm",
...
export const graduateOutcomeConfig: ResourceConfig<GraduateOutcomeRow> = {
  ...
  apiPath: "/api/v1/graduate-outcomes",
  idField: "id",
  roleGroup: "contentManager",
...
export const auditLogConfig: ResourceConfig<AuditLogRow> = {
  ...
  apiPath: "/api/v1/admin/audit-logs",
  idField: "id",
  roleGroup: "adminOnly",
