...
async def chat(req: ChatRequest, request: Request):
    ...
    # The orchestrator includes HTTP, Redis and model calls. Keep those blocking
    # operations away from FastAPI's event loop so concurrent visitors stay responsive.
    result = await run_in_threadpool(_orchestrator.process, message, session_id)
