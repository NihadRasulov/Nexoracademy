...
| Area | Responsibility |
|---|---|
| `frontend/admin-ui/src/auth` | Browser authentication state and role-aware route guards |
| `frontend/admin-ui/src/pages` | Screens with domain-specific behavior |
| `frontend/admin-ui/src/resources` | Reusable configuration-driven CRUD screens |
| `frontend/admin-ui/src/components` | Shared, domain-neutral UI building blocks |
| `frontend/admin-ui/src/lib` | HTTP, formatting, demo infrastructure, and helpers |
