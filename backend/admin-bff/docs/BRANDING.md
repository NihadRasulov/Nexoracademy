...
| Asset | Purpose |
|---|---|
| `frontend/admin-ui/src/assets/nexora-logo-primary.png` | Imported React asset used on login, navigation, and fatal-error screens |
| `frontend/admin-ui/public/favicon.png` | Square browser favicon derived from the “N” mark |
