...
INSERT INTO identity.users
  (id, email, email_verified_at, phone, first_name, last_name, password_hash, role, status, locale, profile, last_login_at, created_at)
VALUES
 ...
 ('a0000000-0000-4000-8000-000000000021','elchin.mammadov@nexora-test.az', now()-interval '300 days','+994501112221','Elçin','Məmmədov','$2b$10$pYmfcxfiqVssARHvw8VX..Kuq/04TVUd1fTQVM/8.iBTRfH.bsTzC','content_manager','active','az-AZ','{"title":"Baş müəllim"}', now()-interval '1 day', now()-interval '300 days'),
 ...
 -- qonaqlar
 ('a0000000-0000-4000-8000-000000000023','guest.one@nexora-test.az',       NULL, NULL,'Qonaq','Birinci','$2b$10$pYmfcxfiqVssARHvw8VX..Kuq/04TVUd1fTQVM/8.iBTRfH.bsTzC','guest','active','az-AZ','{}', NULL, now()-interval '10 days'),
 ('a0000000-0000-4000-8000-000000000024','guest.two@nexora-test.az',       NULL, NULL,'Qonaq','İkinci','$2b$10$pYmfcxfiqVssARHvw8VX..Kuq/04TVUd1fTQVM/8.iBTRfH.bsTzC','guest','active','en-US','{}', NULL, now()-interval '4 days');
