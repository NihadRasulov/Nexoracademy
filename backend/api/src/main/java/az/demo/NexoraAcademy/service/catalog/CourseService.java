...
public class CourseService {
    ...
    @Transactional(readOnly = true)
    public Page<CourseResponse> searchPublished(String query, Short categoryId, DifficultyLevel difficulty,
                                                 DeliveryFormat deliveryFormat, Pageable pageable) {
        return courseRepository
                .findAll(
                        CourseSpecifications.search(query, categoryId, difficulty, deliveryFormat, true, true)
    ...
    public CourseResponse create(CourseRequest request) {
        ...
        course.setInstructor(resolveInstructor(request.instructorId()));
    ...
    public CourseResponse patch(UUID id, CourseRequest request) {
        ...
        if (request.instructorId() != null) course.setInstructor(resolveInstructor(request.instructorId()));
    ...
    public void delete(UUID id) {
        ...
        imageUploadService.delete(course.getImageUrl());
    }
    ...
    private CourseResponse toResponse(Course course) {
        return new CourseResponse(
                ...
                toPublicInstructor(course.getInstructor()),
                course.getTitle(),
                course.getImageUrl(),
    ...
    private PublicInstructorResponse toPublicInstructor(Instructor instructor) {
        if (instructor == null) return null;
        return new PublicInstructorResponse(
                instructor.getId(), instructor.getFullName(), instructor.getBio(), instructor.getPhotoUrl(),
                instructor.getLinkedinUrl(), instructor.getAvgRating(), instructor.getCertifications());
    }
}
