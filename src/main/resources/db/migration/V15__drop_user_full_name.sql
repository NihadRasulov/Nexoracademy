-- V15__drop_user_full_name.sql
-- identity.users.full_name -> first_name + last_name  (CONTRACT mərhələsi)
--
-- ⚠️ BUNU YALNIZ V14-Ü DAŞIYAN RELİZ TAM YAYILANDAN VƏ KÖHNƏ PODLAR
--    SÖNDÜKDƏN SONRA İŞƏ SAL. Əks halda hələ full_name-i NOT NULL bilən köhnə
--    instansiya INSERT zamanı çökər.
--
-- Prod-da bu migration `spring.flyway.target: 14` ilə bloklanıb — aktivləşdirmək üçün
-- application-prod.yml-də target dəyərini 15 et (və ya sətri tamamilə sil), sonra deploy et.
...
-- 2) Ehtiyat: V14-dən sonra hər hansı sətir boş qalıbsa (məs. trigger-dən yan keçən
